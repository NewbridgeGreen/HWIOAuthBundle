...
use HWI\Bundle\OAuthBundle\OAuth\ResourceOwner\XeroResourceOwner;
use Symfony\Component\HttpKernel\Kernel;

class XeroResourceOwnerTest extends GenericOAuth1ResourceOwnerTest
{
    ...
    protected function createResourceOwner(array $options, $name, $paths = null)
    {
        ...
        return new XeroResourceOwner($this->buzzClient, $httpUtils, $options, $name, $this->storage);
    }
    ...
    {
        $this->assertEquals('https://api.xero.com/api.xro/2.0/Users', $this->resourceOwner->getOption('infos_url'));
    }
}
